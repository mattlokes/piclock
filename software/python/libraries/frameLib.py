...
class frameLib ():
   ...
   RED     =bytearray([0xFF,0x00,0x00,0x00])
   GREEN   =bytearray([0x00,0xFF,0x00,0x00])
   BLUE    =bytearray([0x00,0x00,0xFF,0x00])
   CYAN    =bytearray([0x00,0xFF,0xFF,0x00])
   YELLOW  =bytearray([0xFF,0xFF,0x00,0x00])
   MAGENTA =bytearray([0xFF,0x00,0xFF,0x00])
   WHITE   =bytearray([0xFF,0xFF,0xFF,0x00])
